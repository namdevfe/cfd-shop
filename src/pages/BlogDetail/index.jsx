...
import BlogDetailEntry from "./BlogDetailEntry";
import BlogDetailRelated from "./BlogDetailRelated";

const BlogDetail = () => {
  const { name, blogDetailEntryProps, relatedBlogProps } = useBlogDetailPage();
    ...
    <main className="main">
      ...
      <div className="page-content">
        <div className="container">
          <div className="row">
            <div>
              <BlogDetailEntry {...blogDetailEntryProps} />
              <BlogDetailRelated {...relatedBlogProps} />
            </div>
